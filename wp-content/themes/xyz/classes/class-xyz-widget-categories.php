 ...
 * @see WP_Widget
 */
class Xyz_Widget_Categories extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'                   => 'xyz_widget_categories',
			'description'                 => __( 'A list or dropdown of categories.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'xyz_categories', __( 'xyz_Categories' ), $widget_ops );
	}
...
/* ]]> */
	...
	public function form( $instance ) {
		...
		?>require get_template_directory() . '/inc/customizer.php';ho $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:' ); ?></label>
...
add_action('widgets_init', function() {
    register_widget('Xyz_Widget_Categories');
})
;
